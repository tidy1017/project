$(function($) {
    ...
    $("#username").on("keyup", function() {
        ...
        if ($("#username").val() != "") {
            if (reg.test($("#username").val())) {
                ...
                // var url = "../../php/sousuo_tlh.php";
                var url = "http://10.31.157.25:8080/project/project/php/sousuo_tlh.php";
                $.ajax({
                    type: "POST",
                    url: url,
                    data: data,
    ...
    $(".btn").on("click", function() {
        ...
        var url = "http://10.31.157.25:8080/project/project/php/register.php";
        $.ajax({
            type: "POST",
            url: url,
            data: data,
                    ...
                    if ($("#username").val() != "" && $("#pwd").val() != "") {
                        ...
                        (function(i) {
                            tId = setInterval(function() {
                                ...
                                i--;
                                if (i == 0) {
                                    location.href = "../html/about_nlf.html";
                                }
                            }, 1000);
                        })(i);
                    }
